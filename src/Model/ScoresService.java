...
import java.util.List;
    ...
    public class ScoresService {
        public static void selectAll(List<Scores> targetList, DatabaseConnection database) {
            ...
            PreparedStatement statement = database.newStatement("SELECT UserID, QuizName, Score FROM Scores");
      ...
      /*  public static void save (Scores itemToSave , DatabaseConnection database){
            ...
            try{
                if (existingItem==null){
                    PreparedStatement statement= database.newStatement("INSERT into Scores, UserID,QuizName, Score VALUES ")
                }
            }
